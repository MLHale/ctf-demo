...
define('ctf-demo/tests/lint/app.lint-test', [], function () {
  'use strict';
...
define('ctf-demo/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('ctf-demo/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ctf-demo/templates/application.hbs should pass TemplateLint.\n\n');
  });
});
define('ctf-demo/tests/lint/tests.lint-test', [], function () {
  'use strict';
...
define('ctf-demo/tests/test-helper', ['ctf-demo/app', 'ctf-demo/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
require('ctf-demo/tests/test-helper');
